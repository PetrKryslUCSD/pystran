...
# ## Problem description
# 
# Alternative version of `08_refine_member_tut.ipynb`. Joint and member identifiers
# are strings.
# 
# Variation on  `02_continuous_beam_2_spans_consist_tut.ipynb`. The member 2 is
...
# joints and members. The old member `'m2'` is removed.
# 
...
# `02_continuous_beam_2_spans_consist_tut.ipynb`. The deformed shape shows the
...
# ## Conclusions
# 
# Members can be easily subdivided into finite elements.
